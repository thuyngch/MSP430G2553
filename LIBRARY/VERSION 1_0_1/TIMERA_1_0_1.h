 ...
 *************************************************************************************************/
 /* Setup */
void
timerASetup (const unsigned int TIMER_A_, const unsigned int MODE_, const unsigned int DIV_,
		const unsigned int INT_OVF_, unsigned int varTarInit, unsigned int varCcr0Init);
void
timerAStop (const char TIMER_A_);
void
timerACapSetup (const unsigned int TIMER_A_, const unsigned int CCR_,
		const unsigned int CHANNEL_, const unsigned int MODE_, const unsigned int INT_CC_);
	// CCR0 is not used for ModeUp & ModeUpDown
void
timerACmpSetup (const unsigned int TIMER_A_, const unsigned int CCR_,
		const unsigned int INT_CC_, unsigned int varCcrInit);
void
pwmSetup (const unsigned int TIMER_A_, const unsigned int MODE_,
