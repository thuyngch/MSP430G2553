...
#ifndef USE_DS1307_1_0_3
	/* RTD data variables and arrays */
	unsigned char varSecond, varMinute, varHour, varDay, varDate, varMonth, varYear;
	unsigned char arrRtcData[DS1307_BYTE_OF_DATA];
#endif	/* DS1307_1_0_3 */
